...
fig<-plot_ly(podaci,x=~drzava, y=~zarazeni,type='bar',name="Zara탑eni virusom")
fig<-fig%>%add_trace(y=~izljeceni,name="Izlje훾eni od virusa")
...
fig<-plot_ly(data,x=~hrv, y=~zarazeni,type='bar',name="Zara탑eni virusom")
fig<-fig%>%add_trace(y=~izljeceni,name="Izlje훾eni od virusa")
fig<-fig%>%add_trace(y=~umrli,name="Umrli od virusa")
fig<-fig%>%layout(yaxis=list(title="Broj"),barmode="group")
fig
...
fig<-plot_ly(itadata,x=~ita, y=~zarazeni,type='bar',name="Zara탑eni virusom")
fig<-fig%>%add_trace(y=~izljeceni,name="Izlje훾eni od virusa")
fig<-fig%>%add_trace(y=~umrli,name="Umrli od virusa")
fig<-fig%>%layout(yaxis=list(title="Broj"),barmode="group")
fig
...
plot_ly(
  x=c("22/01","23/01", "24/01", "25/01", "26/01", "27/01",
      ...
      "10/03","11/03","12/03","13/03","14/03","15/03","16/03","17/03","18/03","19/03","20/03","21/03","22/3"),
  y=cro$Value[1:61],
  name = "Rast zara탑enih u hrvatskoj",
  type="bar") %>%
  layout(xaxis=xform)
